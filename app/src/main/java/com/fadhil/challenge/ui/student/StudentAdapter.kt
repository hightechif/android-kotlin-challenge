...
class StudentAdapter(private val onItemClicked: (Student) -> Unit, private val studentList: MutableList<Student>) : ListAdapter<Student, StudentAdapter.StudentViewHolder>(
    DiffCallback
) {
